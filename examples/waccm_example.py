...
config = {
    "source": "waccm",
    "intmpl": "inputs/WACCM/f.e22.beta02.FWSD.f09_f09_mg17.cesm2_2_beta02.forecast.001.cam.h3.%Y-%m-%d-00000.nc",
    "GDNAM": GDNAM, "VGNAM": VGNAM,  # Destination Horizontal and Vertical Grids
    "bcon_dates": dates, "icon_dates": dates[:1],
    "exprs": ["waccm_o3so4.json"],  # comment out; default cb6_ae7
}
...
fig.savefig('outputs/figs/wacmm_profiles.png')
